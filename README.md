...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/little-tree-4176)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/little-tree-4176
```

A live public deployment of this template is available at [https://little-tree-4176.templates.workers.dev](https://little-tree-4176.templates.workers.dev)
